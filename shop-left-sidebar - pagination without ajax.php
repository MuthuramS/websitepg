...
if (!empty($_SERVER['QUERY_STRING'])) {
    // echo "URL has query parameters: " . $_SERVER['QUERY_STRING'];
    $type = $_GET['type'];
    ...
    if ($type == 'new lanch') {
        ...
        $countSql = "SELECT COUNT(*) AS total FROM intrested_properties LEFT JOIN locations AS loc ON intrested_properties.locality = loc.loc_id 
                    WHERE intrested_properties.created_on >= DATE_SUB(NOW(), INTERVAL 1 YEAR) 
                    AND intrested_properties.prpt_sts = 1";
    ...
    if(isset($_POST)){
        $type = $_POST['type'];
            ...
            LEFT JOIN locations AS loc ON intrested_properties.locality = loc.loc_id  
            WHERE intrested_properties.possession <= DATE_SUB(NOW(), INTERVAL 1 MONTH) 
            AND intrested_properties.prpt_sts = 1 AND `type`='$type'";
    }
                            ...
                            <div class="tab-pane fade active show" id="liton_product_grid">
                                <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                    <div class="row">
                                        ...
                                        <!-- ltn__product-item -->
                                        <?php foreach ($results as $proper) { ?>
                                            <div class="col-xl-6 col-sm-6 col-12">
                                                <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                                <a href="product-details.php?product_id=<?= $proper['prpt_id'];?>" target="_blank">
                                                    <div class="ltn__gallery-item-img">
                                                        <!-- <a href="img/gallery/1.jpg" data-rel="lightcase:myCollection"> -->
                                                            ...
                                                            <span class="configration text-color-white mr-3 position-absolute">
                                                                <?php
                                                                $bhk = str_replace("BHK", "", $proper['configuration']);
                                                                echo $bhk . " BHK";
                                                                ?>
                                                            </span>
                                                        <!-- </a> -->
                                                    ...
                                                    <div class="ltn__gallery-item-info p-2">
                                                        <h4><a href="portfolio-details.html"><?php echo $proper['property_name']; ?>
                                                            </a></h4>
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                <p><i class="fa fa-expand text-success ml-2"></i><span class="ml-2">
                                                                        ...
                                                                        $min_size = $sizes;
                                                                        $max_size = max([
                                                                            strval($proper['1bhk_size_max']),
                                                                            strval($proper['1_5bhk_size_max']),
                                                                            strval($proper['2bhk_size_max']),
                                                                            strval($proper['2_5bhk_size_max']),
                                                                            strval($proper['3bhk_size_max']),
                                                                            strval($proper['4bhk_size_max']),
                                                                            strval($proper['5bhk_size_max'])
                                                                        ]);

                                                                        if ($min_size && $max_size) {
                                                                            echo "{$min_size} - {$max_size} SQ.FT";
                                                                        } elseif ($min_size) {
                                                                            echo "{$min_size} SQ.FT";
                                                                        } elseif ($max_size) {
                                                                            echo "{$max_size} SQ.FT";
                                                            ...
                                                            <div>
                                                                <p><i class="fa fa-calendar-alt text-success ml-2"></i><span class="ml-2">DEC 2024</span></p>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex">
                                                            <ul class="d-flex list-inline list-group list-group-horizontal justify-content-center ml-auto mr-auto">
                                                                <li class="">
                            ...
                            <div class="ltn__pagination">
                                <ul>
                                    <?php if ($currentPage > 1) { ?>
                                        ...
                                        <li><a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $currentPage - 1])); ?>"><i class="fas fa-angle-left"></i></a></li>
                                    <?php } ?>

                                    <?php
                                    // Number of pages to show initially
                                    $numPagesToShow = 7; // Adjust this number as needed
                                    ...
                                    ?>
                                        <li <?php if ($page == $currentPage) echo 'class="active"'; ?>>
                                            <a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $page])); ?>"><?php echo $page; ?></a>
                                        </li>
                                    <?php } ?>

                                    <?php if ($currentPage < $totalPages) { ?>
                                        <li><a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $currentPage + 1])); ?>"><i class="fas fa-angle-right"></i></a></li>
                                        <li><a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $totalPages])); ?>"><i class="fas fa-angle-double-right"></i></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
