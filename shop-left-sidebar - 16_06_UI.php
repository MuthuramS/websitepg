                                    ...
                                    <div class="col-xl-6 col-sm-6 col-12">
                                        <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="d-flex">
                                                    <p>Land</p>
                                                    <p class="px-3">₹ 1.28 l - 10.29 cr</p>
                                                </div>
                                                <div class="product-hover-action">
                                                    ...
                                                    <ul class="float-right">
                                                        <li>
                                                            <button type="button" title="Broucher" style="background-color: unset;"><i class="fa-solid fa-file-arrow-down"></i></button>
                                                        </li>
                                                        <li>
                                                            <button type="button" title="Get Enquiry" style="background-color: unset;"><i class="fa-solid fa-phone"></i></button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
